...
export const loginThunkCreate = (email: string, password: string, rememberMe: boolean, captcha: string | null, setStatus: (status: any) => void): ThunkAction<Promise<void>, AppStateType, unknown, AuthActionsType | FormAction> =>
    async (dispatch) => {
