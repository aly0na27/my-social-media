...
let initialState = {
    ...
    dialogs: [
        ...
        },
        {
            id: 6,
            name: "Laura",
            avatar: "https://4seller.ru/wp-content/uploads/2020/11/2484704267.jpg"}
    ] as Array<DialogType>,
}
...
export const addMessageCreateAction = (newMessage: string): AddMessageActionType => ({type: ADD_MESSAGE, message: newMessage})
